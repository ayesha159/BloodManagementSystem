                    ...
                    <form action="#" class="row">
                        ...
                        <div class="col-md-12">
                           <label>Password</label>
                            <asp:TextBox ID="txtPwd" runat="server"  class="form-control main"  required/>
                        </div>

                        <div class="col-md-12">
                           <label>Re-Type Password</label>
                            <asp:TextBox ID="txtPwd2" runat="server"  class="form-control main"  required/>
                        </div>

                        <div class="col-md-12">
                          <asp:Label ID="lblmsg" runat="server"  class="form-control main"  required/>
                        </div>
