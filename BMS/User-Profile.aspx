<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="User-Profile.aspx.cs" Inherits="User_Profile" MaintainScrollPositionOnPostback="true" %>
                ...
                <div class="contact-form">
                    ...
                    <form action="#" class="row">
                        ...
                        <div class="col-md-12">
                          ...
                          <asp:Label ID="lblEmail" runat="server"  class="form-control"/>
                        </div>
                        ...
                        <div class="col-md-12 text-right">
                          <asp:Button ID="btnUpdate" runat="server"  class="btn btn-style-one"  Text="Update" OnClick="btnUpdate_Click"  />
                        </div>
                    </form>
                    <!-- contact form end -->
                </div>
